...
`,
    ...
    var b = ((e) => {
      ...
      function t(r) {
        for (var a, n = arguments.length, o = new Array(n > 1 ? n - 1 : 0), s = 1; s < n; s++)
          o[s - 1] = arguments[s];
        return (a = e.call(this, be.apply(void 0, [he[r]].concat(o))) || this), de(a);
      }
      return t;
    })($(Error));
    function M(e) {
    ...
    function S(e) {
      ...
      if (t.match(xe)) {
        var r = Number.parseFloat((Number.parseInt('' + t[7] + t[8], 16) / 255).toFixed(2));
        return {
          red: Number.parseInt('' + t[1] + t[2], 16),
          green: Number.parseInt('' + t[3] + t[4], 16),
          blue: Number.parseInt('' + t[5] + t[6], 16),
      ...
      if (t.match(Te)) {
        var a = Number.parseFloat((Number.parseInt('' + t[4] + t[4], 16) / 255).toFixed(2));
        return {
          red: Number.parseInt('' + t[1] + t[1], 16),
          green: Number.parseInt('' + t[2] + t[2], 16),
          blue: Number.parseInt('' + t[3] + t[3], 16),
      ...
      if (f) {
        var w = Number.parseInt('' + f[1], 10),
          pe = Number.parseInt('' + f[2], 10) / 100,
          ue = Number.parseInt('' + f[3], 10) / 100,
          Y = 'rgb(' + E(w, pe, ue) + ')',
          I = B.exec(Y);
        if (!I) throw new b(4, t, Y);
        return {
    ...
    function Ee(e, t, r) {
      return D('#' + N(e) + N(t) + N(r));
    }
    function F(e, t, r) {
      return E(e, t, r, Ee);
    }
    function Ie(e, t, r) {
      if (typeof e == 'number' && typeof t == 'number' && typeof r == 'number') return F(e, t, r);
    ...
    function Re(e, t, r, a) {
      if (
        ...
        return a >= 1 ? F(e, t, r) : 'rgba(' + E(e, t, r) + ',' + a + ')';
    ...
    function q(e, t, r) {
      if (typeof e == 'number' && typeof t == 'number' && typeof r == 'number')
        return D('#' + v(e) + v(t) + v(r));
      if (typeof e == 'object' && t === void 0 && r === void 0)
        return D('#' + v(e.red) + v(e.green) + v(e.blue));
      throw new b(6);
    }
    function O(e, t, r, a) {
    ...
    function ze(e, t) {
      ...
      var r = g(t);
      return y(d({}, r, { hue: r.hue + Number.parseFloat(e) }));
    }
    c(ze);
    function T(e, t, r) {
    ...
    function Ae(e, t) {
      if (t === 'transparent') return t;
      var r = g(t);
      return y(d({}, r, { lightness: T(0, 1, r.lightness - Number.parseFloat(e)) }));
    }
    c(Ae);
    function Me(e, t) {
      if (t === 'transparent') return t;
      var r = g(t);
      return y(d({}, r, { saturation: T(0, 1, r.saturation - Number.parseFloat(e)) }));
    }
    c(Me);
    function Be(e, t) {
      if (t === 'transparent') return t;
    ...
    function $e(e, t) {
      ...
      var r = S(t),
        ...
        n = d({}, r, { alpha: T(0, 1, (a * 100 + Number.parseFloat(e) * 100) / 100) });
      return O(n);
    }
    c($e);
    function De(e, t) {
    ...
    c(De);
    function qe(e, t) {
      return t === 'transparent' ? t : y(d({}, g(t), { hue: Number.parseFloat(e) }));
    }
    c(qe);
    function We(e, t) {
      return t === 'transparent' ? t : y(d({}, g(t), { lightness: Number.parseFloat(e) }));
    }
    c(We);
    function Ye(e, t) {
      return t === 'transparent' ? t : y(d({}, g(t), { saturation: Number.parseFloat(e) }));
    }
    c(Ye);
    function Ge(e, t) {
      return t === 'transparent' ? t : ie(Number.parseFloat(e), 'rgb(0, 0, 0)', t);
    }
    c(Ge);
    function Ke(e, t) {
      return t === 'transparent' ? t : ie(Number.parseFloat(e), 'rgb(255, 255, 255)', t);
    }
    c(Ke);
    function Ue(e, t) {
      if (t === 'transparent') return t;
      var r = S(t),
        a = typeof r.alpha == 'number' ? r.alpha : 1,
        n = d({}, r, { alpha: T(0, 1, +(a * 100 - Number.parseFloat(e) * 100).toFixed(2) / 100) });
      return O(n);
    }
    var Ze = c(Ue),
      Je = Ze,
      ...
      tt = () =>
        l.createElement(
          ...
          l.createElement(R, { style: { width: '80%' } }),
          l.createElement(R, { style: { width: '30%' } }),
          l.createElement(R, { style: { width: '80%' } })
        ),
