try {
  (() => {
    ...
    var Ae = 'storybook/highlight',
      ...
      Fe = `${Ae}/remove`,
      ff = `${Ae}/reset`,
      Dt = `${Ae}/scroll-into-view`;
    O();
    w();
    k();
    var Sf = __REACT_DOM__,
      {
    ...
    var z = { VIOLATION: 'violations', PASS: 'passes', INCOMPLETION: 'incomplete' },
      Fr = {
        'area-alt': {
          title: '<area> alt text',
      ...
      en = { ...Fr, ...Hr, ...Ur, ...Br, ...Gr, ...jr, ...zr },
      We = (e) => en[e.id]?.title || e.id,
      ...
      Qr = `${B}/manual`,
      Xr = `${B}/select`,
      Zr = 'writing-tests/accessibility-testing',
      Jr = `${Zr}#why-are-my-tests-failing-in-different-environments`,
      se = { RESULT: Yr, REQUEST: Vr, RUNNING: qr, ERROR: Kr, MANUAL: Qr, SELECT: Xr },
      ...
      na = (e) => {
        const t = bt('a11y', {}),
          [r] = yt() ?? [],
          n = Re(),
          a = R((y = !1) => (y ? 'manual' : 'initial'), []),
          i = W(() => r?.a11y?.manual ?? !1, [r?.a11y?.manual]),
          l = W(() => {
        ...
        const Y = R(() => v((y) => !y), []),
          ...
          _ = W(() => s?.[c]?.every((y) => C.has(`${c}.${y.id}`)) ?? !1, [s, C, c]),
          x = R((y, $, S) => {
            y.stopPropagation();
            const T = `${$}.${S.id}`;
          ...
          ce = R(
            (y, $) => {
              const [S, T] = y.split('.'),
                { helpUrl: M, nodes: ye } = s?.[S]?.find((ue) => ue.id === T) || {},
          ...
          Tn = R(async (y) => {
            const { createCopyToClipboardFunction: $ } = await Promise.resolve().then(
              () => (Ne(), mt)
            );
    ...
    var Ge = 'rovingFocusGroup.onEntryFocus',
      ...
      $a = L((e, t) => {
        const {
          ...
          f = ua(t, u),
          b = un(i),
          [h = null, I] = cn({ prop: l, defaultProp: s, onChange: d }),
          [v, g] = H(!1),
          A = ga(c),
          Y = dn(r),
          C = j(!1),
                  ...
                  if (x.target === x.currentTarget && F && !v) {
                    ...
                    if ((x.currentTarget.dispatchEvent(q), !q.defaultPrevented)) {
                      const te = Y().filter((K) => K.focusable),
                        ...
                        re = te.find((K) => K.id === h),
                        ce = [ne, re, ...te].filter(Boolean).map((K) => K.ref.current);
                      pn(ce);
                    }
                  }
                  C.current = !1;
      ...
      Ca = L((e, t) => {
        const {
          ...
          d = i || s,
          c = Aa(Ta, r),
          p = c.currentTabStopId === d,
          u = dn(r),
          { onFocusableItemAdd: f, onFocusableItemRemove: b } = c;
        return (
          G(() => {
            if (n) return f(), () => b();
          }, [n, f, b]),
    ...
    var fn = (e) => {
      const { present: t, children: r } = e,
        n = Ua(t),
        a = typeof r == 'function' ? r({ present: n.isPresent }) : P.only(r),
        i = Fa(n.ref, a.ref);
    ...
    var Ya = [
      ...
      Ka = L((e, t) => {
        const {
          ...
          p = un(s),
          [u, f] = cn({ prop: n, onChange: a, defaultProp: i });
        return m(
          qa,
          {
            scope: r,
    ...
    var no = Ka,
      ...
      oo = E.div({ display: 'flex', flexDirection: 'column' }),
      lo = E.div(({ theme: e }) => ({
        display: 'block',
      ...
      mo = E.div({ display: 'flex', flexDirection: 'column', gap: 10 }),
      po = E.div({ display: 'flex', gap: 10 }),
      fo = ({ onClick: e }) => {
        const [t, r] = H(!1),
          n = R(() => {
            e(), r(!0);
      ...
      ho = ({ id: e, item: t, type: r, selection: n, handleSelectionChange: a }) =>
        o.createElement(
          so,
          { id: e },
          o.createElement(
    ...
    function zt(e) {
      const { handleCopyLink: t, handleJumpToElement: r } = nt(),
        { any: n, all: a, none: i, html: l, target: s } = e,
        d = [...n, ...a, ...i];
      return o.createElement(
        o.Fragment,
        null,
...
${s} {}`
    ...
    var yo = { minor: 'neutral', moderate: 'warning', serious: 'negative', critical: 'critical' },
      bo = { minor: 'Minor', moderate: 'Moderate', serious: 'Serious', critical: 'Critical' },
      go = E.div(({ theme: e }) => ({
        display: 'flex',
        flexDirection: 'column',
        width: '100%',
      ...
      So = E(Et)({ transition: 'transform 0.1s ease-in-out' }),
      vo = E.div(({ theme: e }) => ({
        display: 'flex',
    ...
    var lt = _o,
      $o = typeof $e == 'object' && $e && $e.Object === Object && $e,
      To = $o,
      Co = To,
      Oo = typeof self == 'object' && self && self.Object === Object && self,
      wo = Co || Oo || Function('return this')(),
      vn = wo,
      ko = vn,
      No = () => ko.Date.now(),
      Po = No,
    ...
    var Lo = Mo,
      ...
      Ho = /^\s+/;
    function Uo(e) {
      return e && e.slice(0, Fo(e) + 1).replace(Ho, '');
    }
    var Go = Uo,
      Bo = vn,
      jo = Bo.Symbol,
    ...
    var Tl = $l,
      ...
      oe = () => typeof window > 'u',
      Xt = (e) => e instanceof Element || e instanceof HTMLDocument,
      An = (e, t, r, n) => (a) => {
        var i = a.width,
          l = a.height;
        t((s) =>
      ...
      return (
        ...
        (t.prototype.render = function () {
          var r = this.props,
            ...
            d = s.width,
            c = s.height,
            p = { width: d, height: c, targetRef: this.targetRef },
    ...
    var wl = E.div({ width: '100%', position: 'relative', minHeight: '100%' }),
      kl = E.button(
        ({ theme: e }) => ({
          textDecoration: 'none',
          padding: '10px 15px',
      ...
      Ml = E(ie)({ '@container (max-width: 193px)': { span: { display: 'none' } } }),
      Ll = ({ tabs: e }) => {
      ...
      Fl = E.div(({ theme: { color: e, typography: t, background: r } }) => ({
        textAlign: 'start',
        padding: '11px 15px',
      ...
      ze = E.div({ display: 'flex', alignItems: 'center', gap: 6 }),
      Jt = E.span(({ theme: e }) => ({
        display: 'flex',
        flexDirection: 'column',
        alignItems: 'center',
      ...
      Yl = E.span({ display: 'flex', flexDirection: 'column' }),
      Vl = E.span({ textTransform: 'capitalize' }),
      ql = E.span(({ theme: e }) => ({ fontSize: 11, color: e.textMutedColor })),
      Kl = (e, t) => [
        ...(e !== null
          ? [
              {
