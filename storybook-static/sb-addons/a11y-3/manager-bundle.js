try {
  (() => {
    ...
    Nn(mt, {
      ...
      codeCommon: () => Oa,
      components: () => wa,
      createCopyToClipboardFunction: () => ka,
      default: () => Dn,
      getStoryHref: () => Na,
    ...
    var Ci = __STORYBOOK_API__,
      {
        ...
        experimental_requestResponse: zi,
        experimental_useStatusStore: pt,
        experimental_useTestProviderStore: Wi,
        experimental_useUniversalStore: ji,
        ...
        merge: Ji,
        mockChannel: ec,
        optionOrAltSymbol: tc,
        shortcutMatchesShortcut: nc,
    ...
    w();
    k();
    var fc = __STORYBOOK_ICONS__,
      {
        AccessibilityAltIcon: pc,
        AccessibilityIcon: St,
        AccessibilityIgnoredIcon: hc,
        AddIcon: yc,
        AdminIcon: bc,
        AlertAltIcon: gc,
        AlertIcon: Sc,
        ...
        AlignRightIcon: Ec,
        AppleIcon: Ic,
        ArrowBottomLeftIcon: xc,
        ArrowBottomRightIcon: Rc,
        ArrowDownIcon: Ac,
        ArrowLeftIcon: $c,
        ArrowRightIcon: Tc,
        ArrowSolidDownIcon: _c,
        ArrowSolidLeftIcon: Cc,
        ArrowSolidRightIcon: Oc,
        ArrowSolidUpIcon: wc,
        ArrowTopLeftIcon: kc,
        ArrowTopRightIcon: Nc,
        ArrowUpIcon: Pc,
        AzureDevOpsIcon: Dc,
        BackIcon: Mc,
        BasketIcon: Lc,
        ...
        BoldIcon: zc,
        BookIcon: Wc,
        BookmarkHollowIcon: jc,
        BookmarkIcon: Yc,
        BottomBarIcon: Vc,
        BottomBarToggleIcon: qc,
        BoxIcon: Kc,
        BranchIcon: Qc,
        BrowserIcon: Xc,
        ButtonIcon: Zc,
        ...
        ChevronSmallLeftIcon: us,
        ChevronSmallRightIcon: ds,
        ChevronSmallUpIcon: ms,
        ChevronUpIcon: fs,
        ChromaticIcon: ps,
        ChromeIcon: hs,
        CircleHollowIcon: ys,
        ...
        CommitIcon: _s,
        CompassIcon: Cs,
        ComponentDrivenIcon: Os,
        ComponentIcon: ws,
        ContrastIcon: ks,
        ContrastIgnoredIcon: Ns,
        ControlsIcon: Ps,
        CopyIcon: xt,
        CreditIcon: Ds,
        CrossIcon: Ms,
    ...
    w();
    k();
    var uf = __STORYBOOK_CORE_EVENTS__,
      {
        ARGTYPES_INFO_REQUEST: df,
        ARGTYPES_INFO_RESPONSE: mf,
        CHANNEL_CREATED: ff,
        CHANNEL_WS_DISCONNECT: pf,
        CONFIG_ERROR: hf,
        CREATE_NEW_STORYFILE_REQUEST: yf,
        CREATE_NEW_STORYFILE_RESPONSE: bf,
        CURRENT_STORY_WAS_SET: gf,
        DOCS_PREPARED: Sf,
        DOCS_RENDERED: vf,
        FILE_COMPONENT_SEARCH_REQUEST: Ef,
        FILE_COMPONENT_SEARCH_RESPONSE: If,
        FORCE_REMOUNT: xf,
        FORCE_RE_RENDER: Rf,
        GLOBALS_UPDATED: Af,
        NAVIGATE_URL: $f,
        PLAY_FUNCTION_THREW_EXCEPTION: Tf,
        PRELOAD_ENTRIES: _f,
        PREVIEW_BUILDER_PROGRESS: Cf,
        PREVIEW_KEYDOWN: Of,
        REGISTER_SUBSCRIPTION: wf,
        REQUEST_WHATS_NEW_DATA: kf,
        RESET_STORY_ARGS: Nf,
        RESULT_WHATS_NEW_DATA: Pf,
        SAVE_STORY_REQUEST: Df,
        SAVE_STORY_RESPONSE: Mf,
        SELECT_STORY: Lf,
        SET_CONFIG: Ff,
        SET_CURRENT_STORY: Hf,
        SET_FILTER: Uf,
        SET_GLOBALS: Gf,
        SET_INDEX: Bf,
        SET_STORIES: zf,
        SET_WHATS_NEW_CACHE: Wf,
        SHARED_STATE_CHANGED: jf,
        SHARED_STATE_SET: Yf,
        STORIES_COLLAPSE_ALL: Vf,
        STORIES_EXPAND_ALL: qf,
        ...
        STORY_SPECIFIED: tp,
        STORY_THREW_EXCEPTION: np,
        STORY_UNCHANGED: ap,
        TELEMETRY_ERROR: rp,
        TOGGLE_WHATS_NEW_NOTIFICATIONS: op,
        UNHANDLED_ERRORS_WHILE_PLAYING: lp,
        UPDATE_GLOBALS: ip,
        UPDATE_QUERY_PARAMS: cp,
        UPDATE_STORY_ARGS: sp,
    ...
    var Sp = __REACT_DOM__,
      {
        ...
        unstable_renderSubtreeIntoContainer: _p,
        version: Cp,
      } = __REACT_DOM__;
    var W = { VIOLATION: 'violations', PASS: 'passes', INCOMPLETION: 'incomplete' },
      ...
      Qa = `${B}/manual`,
      Xa = `${B}/select`,
      Za = 'writing-tests/accessibility-testing',
      Ja = `${Za}#why-are-my-tests-failing-in-different-environments`,
      ce = { RESULT: Ya, REQUEST: Va, RUNNING: qa, ERROR: Ka, MANUAL: Qa, SELECT: Xa },
      ...
      nr = (e) => {
        ...
        const Y = R(() => v((y) => !y), []),
          ...
          $ = j(() => c?.[s]?.every((y) => C.has(`${s}.${y.id}`)) ?? !1, [c, C, s]),
          x = R((y, T, S) => {
            y.stopPropagation();
            const _ = `${T}.${S.id}`;
          ...
          se = R(
            (y, T) => {
              const [S, _] = y.split('.'),
                { helpUrl: M, nodes: ye } = c?.[S]?.find((ue) => ue.id === _) || {},
          ...
          _n = R(async (y) => {
            const { createCopyToClipboardFunction: T } = await Promise.resolve().then(
              () => (Ne(), mt)
            );
        ...
        G(() => {
          ...
          G(() => {
            ...
            const y = Array.from(C.values()).flatMap((S) => {
              const [_, M, ye] = S.split('.');
              if (_ !== s) return [];
              const be = c?.[_]?.find((ue) => ue.id === M)?.nodes[Number(ye) - 1]?.target;
              return be ? [String(be)] : [];
            });
            Q(Le, {
              id: `${B}/selected`,
              ...
              menu: c?.[s].map((S) => {
                ...
                return [
                  { id: `${s}.${S.id}:info`, title: je(S), description: Ye(S), selectors: _ },
                  {
                    id: `${s}.${S.id}`,
                    iconLeft: 'info',
                    iconRight: 'shareAlt',
    ...
    function at(e, t = []) {
      ...
      const r = () => {
        const i = a.map((l) => fe(l));
        return (l) => {
          const c = l?.[e] || i;
          return j(() => ({ [`__scope${e}`]: { ...l, [e]: c } }), [l, c]);
        };
      };
      return (r.scopeName = e), [n, ar(r, ...t)];
    }
    function ar(...e) {
      const t = e[0];
    ...
    var or = ({ children: e }) => m(me, null, e);
    function lr(e) {
      return U(e) && e.type === or;
    }
    function ir(e, t) {
      const a = { ...t };
      for (const n in t) {
    ...
    function cr(e) {
      ...
      function p(b) {
        ...
        return o.useCallback(() => {
          ...
          if (!I) return [];
          const v = Array.from(I.querySelectorAll(`[${f}]`));
    ...
    function an(...e) {
      return (t) => e.forEach((a) => sr(a, t));
    }
    function ur(...e) {
      return R(an(...e), e);
    }
    var dr = globalThis?.document ? Ee : () => {},
      mr = ut || (() => {}),
      fr = 0;
    function rn(e) {
      const [t, a] = H(mr());
    ...
    var Qe = L((e, t) => {
      const { children: a, ...n } = e;
      return U(a)
        ? V(a, { ...yr(n, a.props), ref: t ? an(t, a.ref) : a.ref })
        : P.count(a) > 1
          ? P.only(null)
          : null;
    });
    ...
    function sn({ prop: e, defaultProp: t, onChange: a = () => {} }) {
      const [n, r] = Sr({ defaultProp: t, onChange: a }),
        i = e !== void 0,
        l = i ? e : n,
        c = cn(a),
        d = R(
    ...
    function Sr({ defaultProp: e, onChange: t }) {
      const a = H(e),
        [n] = a,
        r = z(n),
        i = cn(t);
    ...
    var Ge = 'rovingFocusGroup.onEntryFocus',
      ...
      $r = L((e, t) =>
        m(
          ...
          m(Xe.Slot, { scope: e.__scopeRovingFocusGroup }, m(Tr, N({}, e, { ref: t })))
        )
      ),
      Tr = L((e, t) => {
        const {
      ...
      Cr = L((e, t) => {
        ...
        return (
          ...
          m(
            ...
            m(
              ln.span,
              N({ tabIndex: f ? 0 : -1, 'data-orientation': s.orientation }, l, {
                ref: t,
                ...
                onKeyDown: ee(e.onKeyDown, (h) => {
                  ...
                  const I = kr(h, s.orientation, s.dir);
                  if (I !== void 0) {
                    h.preventDefault();
                    let v = u()
    ...
    function fn(e) {
      ...
      for (const a of e) if (a === t || (a.focus(), document.activeElement !== t)) return;
    }
    function Nr(e, t) {
    ...
    function Ur(e) {
      ...
      return (
        ...
        Ut(() => {
          if (t) {
            const s = (u) => {
                const p = $e(n.current).includes(u.animationName);
    ...
    var Ze = L((e, t) => {
      const { children: a, ...n } = e;
      return U(a)
        ? V(a, { ...jr(n, a.props), ref: t ? Br(t, a.ref) : a.ref })
        : P.count(a) > 1
          ? P.only(null)
          : null;
    });
    Ze.displayName = 'SlotClone';
    var zr = ({ children: e }) => m(me, null, e);
    function Wr(e) {
      return U(e) && e.type === zr;
    }
    function jr(e, t) {
      const a = { ...t };
      for (const n in t) {
    ...
    var Yr = [
      ...
      Qr = 'TabsList',
      Xr = L((e, t) => {
        const { __scopeTabs: a, loop: n = !0, ...r } = e,
          i = ot(Qr, a),
          l = bn(a);
        return m(
          Pr,
          N({ asChild: !0 }, l, { orientation: i.orientation, dir: i.dir, loop: n }),
          m(_e.div, N({ role: 'tablist', 'aria-orientation': i.orientation }, r, { ref: t }))
        );
      }),
      Zr = 'TabsTrigger',
      Jr = L((e, t) => {
        const { __scopeTabs: a, value: n, disabled: r = !1, ...i } = e,
          l = ot(Zr, a),
          c = bn(a),
          d = gn(l.baseId, n),
          s = Sn(l.baseId, n),
      ...
      eo = 'TabsContent',
      to = L((e, t) => {
        const { __scopeTabs: a, value: n, forceMount: r, children: i, ...l } = e,
          c = ot(eo, a),
          d = gn(c.baseId, n),
          s = Sn(c.baseId, n),
          f = n === c.value,
    ...
    var no = Kr,
      ...
      fo = E.div({ display: 'flex', gap: 10 }),
      po = ({ onClick: e }) => {
        const [t, a] = H(!1),
          n = R(() => {
            e(), a(!0);
            const r = setTimeout(() => a(!1), 2e3);
      ...
      ho = ({ id: e, item: t, type: a, selection: n, handleSelectionChange: r }) =>
        o.createElement(
          co,
          { id: e },
          o.createElement(
    ...
    function Wt(e) {
      const { handleCopyLink: t, handleJumpToElement: a } = nt(),
...
${c} {}`
                ...
                return o.createElement(
                  ...
                  o.createElement(
                    ...
                    l.impact &&
                      o.createElement(
                        le,
                        { status: a === W.PASS ? 'neutral' : yo[l.impact] },
                        bo[l.impact]
                      ),
                    ...
                    o.createElement(
                      ...
                      o.createElement(So, { style: { transform: `rotate(${s ? -180 : 0}deg)` } })
                    )
                  ),
                  s
                    ? o.createElement(ho, {
    ...
    var lt = $o,
      To = typeof Te == 'object' && Te && Te.Object === Object && Te,
      _o = To,
      Co = _o,
    ...
    var ol = rl,
      ...
      cl = '[object Symbol]';
    function sl(e) {
      return typeof e == 'symbol' || (il(e) && ll(e) == cl);
    }
    var ul = sl,
      dl = Go,
      qt = lt,
    ...
    function bl(e) {
      ...
      e = dl(e);
      var a = pl.test(e);
      return a || hl.test(e) ? yl(e.slice(2), a ? 2 : 8) : fl.test(e) ? Kt : +e;
    }
    var gl = bl,
      Sl = lt,
      ze = Po,
    ...
    function Tl(e, t, a) {
      ...
      return (
        Al(a) && ((n = 'leading' in a ? !!a.leading : n), (r = 'trailing' in a ? !!a.trailing : r)),
        Rl(e, t, { leading: n, maxWait: t, trailing: r })
      );
    }
    var _l = Tl,
      Rn = (e, t, a, n) => {
      ...
      An = (e, t, a, n) => (r) => {
        var i = r.width,
          l = r.height;
        t((c) =>
          (c.width === i && c.height === l) || (c.width === i && !n) || (c.height === l && !a)
            ? c
          ...
          switch (u) {
            ...
            case 'child':
              if (((p = r), p.type && typeof p.type == 'string')) {
                f.targetRef;
                var b = Ao(f, ['targetRef']);
                return V(p, b);
              }
              return V(p, f);
            case 'childArray':
              return (p = r), p.map((h) => !!h && V(h, f));
            default:
              return m(l, null);
          }
        }),
    ...
    var wl = E.div({ width: '100%', position: 'relative', minHeight: '100%' }),
            ...
            m(
              ...
              m(
                de,
                {
                  ...
                  hasChrome: !1,
                  placement: 'top',
                  tooltip: m(pe, { note: 'Highlight elements with accessibility violations' }),
                  trigger: 'hover',
                },
                m(
                  Ml,
      ...
      Fl = E.div(({ theme: { color: e, typography: t, background: a } }) => ({
        textAlign: 'start',
        padding: '11px 15px',
      ...
      Hl = ({ discrepancy: e }) => {
        const t = Re().getDocsUrl({ subpath: Ja, versioned: !0, renderer: !0 }),
          a = j(() => {
            switch (e) {
      ...
      Ul = () => {
        ...
        return e.disable || e.test === 'off'
          ...
          : o.createElement(
              ...
              n === 'ready' || n === 'ran'
                ? o.createElement(Ll, { key: 'tabs', tabs: f })
                : o.createElement(
                    Jt,
        ...
        e
          ? e === 'blurred vision'
            ...
            : e === 'grayscale'
              ...
              : `url('#${e}')`
          : 'none',
      Wl = E.div({ '&, & svg': { position: 'absolute', width: 0, height: 0 } }),
      jl = E.span(
        {
          background:
      ...
      Kl = (e, t) => [
        ...(e !== null
          ...
          : []),
        ...zl.map((a) => {
          const n = a.percentage !== void 0 ? `${a.percentage}% of users` : void 0;
          return {
            id: a.name,
            title: o.createElement(
              Yl,
              null,
              o.createElement(Vl, null, a.name),
              n && o.createElement(ql, null, n)
            ),
            onClick: () => {
              t(a);
            },
            right: o.createElement(jl, { filter: a.name }),
            active: e === a,
          };
        }),
      ],
      Ql = () => {
        ...
        return o.createElement(
          o.Fragment,
          null,
          e && o.createElement(_t, { styles: { [`#${Bl}`]: { filter: $n(e.name) } } }),
          o.createElement(
            de,
            {
              placement: 'top',
          ...
          o.createElement(Wl, null, o.createElement(Gl, null))
        );
      },
      Xl = () => {
        ...
        return o.createElement(
          ...
          r === 0
            ? null
            : o.createElement(le, { compact: !0, status: e === Ve ? 'active' : 'neutral' }, r)
        );
      };
    xe.register(B, (e) => {
      xe.add(Ve, {
        ...
        xe.add(Ve, {
          ...
          type: Pe.PANEL,
          render: ({ active: t = !0 }) =>
            o.createElement(nr, null, t ? o.createElement(Ul, null) : null),
          paramKey: ja,
        });
    });
  })();
