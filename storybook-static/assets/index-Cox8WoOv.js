import { g as _, r as o } from './iframe-Cy2I62ob.js';
const s = { exports: {} };
const i = {}; /**
 * @license React
...
const m = o;
function d(e) {
  let r = `https://react.dev/errors/${e}`;
  if (1 < arguments.length) {
    r += `?args[]=${encodeURIComponent(arguments[1])}`;
    for (let t = 2; t < arguments.length; t++) r += `&args[]=${encodeURIComponent(arguments[t])}`;
  }
...
function O(e, r, t) {
  const c = 3 < arguments.length && arguments[3] !== void 0 ? arguments[3] : null;
  return {
    $$typeof: v,
    key: c == null ? null : `${c}`,
    children: e,
...
const f = m.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;
function g(e, r) {
  if (e === 'font') return '';
...
i.createPortal = (e, r) => {
  const t = 2 < arguments.length && arguments[2] !== void 0 ? arguments[2] : null;
...
i.preinit = (e, r) => {
  if (typeof e === 'string' && r && typeof r.as === 'string') {
    const t = r.as;
    const c = g(t, r.crossOrigin);
    const u = typeof r.integrity === 'string' ? r.integrity : void 0;
    const y = typeof r.fetchPriority === 'string' ? r.fetchPriority : void 0;
    t === 'style'
