...
const ne = '-',
  ...
  Fe = (e) => ({ cache: Le(e.cacheSize), parseClassName: Ve(e), sortModifiers: Oe(e), ...Pe(e) }),
  _e = /\s+/,
  Be = (e, n) => {
    const {
        parseClassName: r,
...
const f = (e) => {
  ...
  Xe = /^(inset_)?-?((\d+)?\.?(\d+)[a-z]+|0)_-?((\d+)?\.?(\d+)[a-z]+|0)/,
  De =
    /^(url|image|image-set|cross-fade|element|(repeating-)?(linear|radial|conic)-gradient)\(.+\)$/,
  N = (e) => Ue.test(e),
  d = (e) => !!e && !Number.isNaN(Number(e)),
  S = (e) => !!e && Number.isInteger(Number(e)),
  ee = (e) => e.endsWith('%') && d(e.slice(0, -1)),
  C = (e) => qe.test(e),
  Ke = () => !0,
  Qe = (e) => He.test(e) && !Je.test(e),
  ze = () => !1,
  Ye = (e) => Xe.test(e),
  Ze = (e) => De.test(e),
  eo = (e) => !t(e) && !s(e),
  ...
  lo = () => {
    const e = f('color'),
      ...
      c = () => [s, t, p],
      v = () => [N, 'full', 'auto', ...c()],
      ae = () => [S, 'none', 'subgrid', s, t],
      ie = () => ['auto', { span: ['full', S, s, t] }, S, s, t],
      U = () => [S, 'auto', s, t],
      le = () => ['auto', 'min', 'max', 'fr', s, t],
      Q = () => [
        'start',
        'end',
        'center',
      ...
      a = () => [e, s, t],
      ce = () => [...T(), he, ge, { position: [s, t] }],
      de = () => ['no-repeat', { repeat: ['', 'x', 'y', 'space', 'round'] }],
      me = () => ['auto', 'cover', 'contain', so, oo, { size: [s, t] }],
      Y = () => [ee, W, P],
      x = () => ['', 'none', 'full', g, s, t],
      w = () => ['', d, W, P],
