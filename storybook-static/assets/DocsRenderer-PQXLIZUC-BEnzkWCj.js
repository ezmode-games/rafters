const __vite__mapDeps = (
  i,
  m = __vite__mapDeps,
  d = m.f || (m.f = ['./index-DOdozHKZ.js', './iframe-Cy2I62ob.js', './iframe-CPAnmLjQ.css'])
) => i.map((i) => d[i]);
import { A as E, a as d, H as h, D as x } from './blocks-CwYIOFud.js';
import { _ as c, r as p, e as t } from './iframe-Cy2I62ob.js';
import { renderElement as l, unmountElement as u } from './react-18-Birfx-30.js';
import './index-Cox8WoOv.js';
import './jsx-runtime-BjG_zV1W.js';
const D = { code: d, a: E, ...h };
const _ = class extends p.Component {
  constructor() {
  ...
  constructor() {
    (this.render = async (r, e, n) => {
      ...
      return new Promise((i, m) => {
        c(
          async () => {
            const { MDXProvider: o } = await import('./index-DOdozHKZ.js');
