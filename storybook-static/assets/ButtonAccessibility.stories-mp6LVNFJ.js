import { B as a } from './Button-DdyNQfwD.js';
...
s.parameters = {
  ...
  render: () => <div className="space-y-6 p-4 max-w-2xl">
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2">
            <Button aria-label="Save the current document to your account">
              Save
            </Button>
            <p className="text-xs text-muted-foreground">
              aria-label provides additional context when button text is minimal
  ...
  parameters: {
    ...
    layout: 'fullscreen'
      ...
      ...((c = (o = s.parameters) == null ? void 0 : o.docs) == null ? void 0 : c.source),
    },
    description: {
...
They provide clear context, proper semantics, and predictable behavior.`,
      ...((l = (d = s.parameters) == null ? void 0 : d.docs) == null ? void 0 : l.description),
    },
  },
};
var m, u, p, v, x;
t.parameters = {
  ...
  render: () => <div className="space-y-6 p-4 max-w-2xl">
      ...
      <div className="space-y-4">
        ...
        <div className="text-xs text-muted-foreground space-y-1">
          <div>• <kbd className="px-1.5 py-0.5 bg-muted rounded text-xs">Tab</kbd> to navigate between buttons</div>
          <div>• <kbd className="px-1.5 py-0.5 bg-muted rounded text-xs">Space</kbd> or <kbd className="px-1.5 py-0.5 bg-muted rounded text-xs">Enter</kbd> to activate</div>
  ...
  parameters: {
    ...
    layout: 'fullscreen'
      ...
      ...((p = (u = t.parameters) == null ? void 0 : u.docs) == null ? void 0 : p.source),
    },
    description: {
      story: `Natural Navigation

Keyboard navigation should feel intuitive and predictable.
Focus management creates smooth, logical interaction flows.`,
      ...((x = (v = t.parameters) == null ? void 0 : v.docs) == null ? void 0 : x.description),
    },
  },
};
var h, y, g, b, N;
i.parameters = {
  ...
  render: () => <div className="space-y-8 p-4 max-w-3xl">
      ...
      <div className="text-xs text-muted-foreground">
        <div>All button variants maintain WCAG AA contrast ratios (4.5:1) for optimal readability</div>
      </div>
    </div>,
  parameters: {
    docs: {
...
r.parameters = {
  ...
  parameters: {
    ...
    layout: 'fullscreen'
      ...
      ...((A = (j = r.parameters) == null ? void 0 : j.docs) == null ? void 0 : A.source),
    },
    description: {
      story: `Screen Reader Optimization

Screen readers need semantic structure and clear relationships.
Proper markup creates predictable, navigable experiences.`,
      ...((B = (S = r.parameters) == null ? void 0 : S.docs) == null ? void 0 : B.description),
    },
  },
};
const T = [
...
export {
  s as AccessibilityBasics,
  i as ColorContrastDemo,
  t as KeyboardNavigation,
  r as ScreenReaderOptimization,
