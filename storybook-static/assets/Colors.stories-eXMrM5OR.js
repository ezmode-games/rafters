                          ...
                          e.jsxs('div', {
                            ...
                            children: [
                              e.jsxs('div', {
                                ...
                                children: [
                                  e.jsx('span', { className: 'text-green-600', children: '✓' }),
                                  e.jsx('span', {
        ...
        <div className="prose prose-xl max-w-none">
          <div className="mb-32">
            ...
            <p className="text-body-large text-muted-foreground max-w-4xl">
              Your identity's color system. Our system prioritizes accessibility, 
              semantic meaning, and visual hierarchy over decorative variety.
            </p>
            <p className="text-body text-muted-foreground mt-8">
              To modify your brand colors, visit the <strong>/manage</strong> route in your application.
            </p>
          </div>
            ...
            <div className="space-y-12">
              ...
              <div className="space-y-12">
                <div>
                  ...
                  <p className="text-body text-muted-foreground">Colors communicate meaning, not decoration</p>
                </div>
                <div>
                  <h4 className="heading-component mb-6">Accessibility Core</h4>
                  <p className="text-body text-muted-foreground">WCAG AA compliance is non-negotiable</p>
                </div>
                <div>
                  <h4 className="heading-component mb-6">Context Aware</h4>
                  <p className="text-body text-muted-foreground">Light and dark themes with intentional contrast</p>
                </div>
                <div>
                  <h4 className="heading-component mb-6">Future Ready</h4>
                  <p className="text-body text-muted-foreground">OKLCH color space for perceptual consistency</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-12">
              ...
              <div className="space-y-12">
                <div>
                  ...
                  <p className="text-body text-muted-foreground">Background, foreground, and surface foundations</p>
                </div>
                <div>
                  <h4 className="heading-component mb-6">Interactive Tokens</h4>
                  <p className="text-body text-muted-foreground">Hover, focus, and state management</p>
                </div>
                <div>
                  <h4 className="heading-component mb-6">Semantic Tokens</h4>
                  <p className="text-body text-muted-foreground">Success, warning, error, and info states</p>
                </div>
                <div>
                  <h4 className="heading-component mb-6">Component Tokens</h4>
                  <p className="text-body text-muted-foreground">Specialized colors for specific contexts</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="my-40">
            ...
            <p className="text-body-large text-muted-foreground max-w-4xl mb-20">
              Rafters uses role-based tokens rather than named colors. This allows themes 
              to redefine visual expression while maintaining consistent semantic meaning 
            ...
            <div className="bg-accent/30 p-16 rounded-lg border-l-4 border-primary">
              ...
              <p className="text-body-large text-muted-foreground">
                Every color choice should pass the "why" test: Why this color? 
                Why this contrast? Why this semantic association? Intentional color 
                builds trust through predictable visual language.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="p-8 border rounded-lg bg-background">
              ...
              <div className="text-muted-foreground">
                Primary canvas for all content
              </div>
            </div>
...
for hover, focus, and active interactions while maintaining accessibility.`,
      ...((y = (b = t.parameters) == null ? void 0 : b.docs) == null ? void 0 : y.description),
    },
  },
};
var f, j, k, w, C;
n.parameters = {
  ...
  render: () => <div className="px-16 py-24 max-w-7xl mx-auto">
      <div className="mb-16">
        ...
        <p className="text-body-large text-muted-foreground max-w-3xl">
          Colors that communicate system state and guide user understanding through consistent semantic associations.
          These default grayscale tokens will be customized to your brand identity during onboarding.
        </p>
      </div>
        ...
        <div className="space-y-12">
          ...
          <div className="space-y-3">
            <div className="p-3 border border-destructive/20 bg-destructive/10 rounded-md">
              ...
              <div className="text-sm text-destructive/80">Please check your connection and try again.</div>
            </div>
            ...
            <div className="p-3 border border-success/20 bg-success/10 rounded-md">
              ...
              <div className="text-sm text-success/80">All changes have been automatically backed up.</div>
            </div>
            ...
            <div className="p-3 border border-warning/20 bg-warning/10 rounded-md">
              ...
              <div className="text-sm text-warning/80">Consider upgrading your plan or removing unused files.</div>
            </div>
            ...
            <div className="p-3 border border-info/20 bg-info/10 rounded-md">
              ...
              <div className="text-sm text-info/80">Check out the latest updates in your dashboard.</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-20">
        ...
        <section className="space-y-12">
          ...
          <div className="prose max-w-none">
            <p>
              All color combinations in the Rafters system meet or exceed WCAG AA standards. 
              Our OKLCH color space implementation ensures perceptual consistency across 
              different display conditions and color vision variations.
            </p>
            ...
            <div className="bg-accent/30 p-6 rounded-lg border-l-4 border-primary my-6">
              ...
              <ul className="mb-0">
                ...
                <li><strong>Large text:</strong> 3:1 minimum contrast ratio</li>
                <li><strong>Interactive elements:</strong> 3:1 for focus indicators</li>
                <li><strong>Non-text elements:</strong> 3:1 for meaningful graphics</li>
              </ul>
            </div>
            
            <p>
              Beyond compliance, our system considers color vision differences, 
              environmental viewing conditions, and cognitive load. Every color 
              decision supports inclusive design principles.
            </p>
          </div>
        </section>
          ...
          <div className="space-y-4">
            <div className="p-4 bg-muted rounded-lg">
              ...
              <p className="text-sm text-muted-foreground">
                Always use CSS custom properties (tokens) rather than direct color values. 
                This ensures theme compatibility and maintains semantic consistency.
              </p>
            </div>
            ...
            <div className="p-4 bg-muted rounded-lg">
              ...
              <p className="text-sm text-muted-foreground">
                Use opacity and transform modifiers for interactive states rather than 
                entirely different colors. This maintains color relationships while 
            ...
            <div className="p-4 bg-muted rounded-lg">
              ...
              <p className="text-sm text-muted-foreground">
                When creating new themes, maintain semantic meaning while allowing 
                visual expression. Test thoroughly across all component contexts 
...
Understanding context and accessibility ensures consistent, inclusive experiences.`,
      ...((I = (D = i.parameters) == null ? void 0 : D.docs) == null ? void 0 : I.description),
    },
  },
};
const R = ['Overview', 'CoreTokens', 'InteractiveTokens', 'SemanticTokens', 'UsageGuidelines'];
export {
  a as CoreTokens,
