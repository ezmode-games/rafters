...
var $ = (r, l, s) => (l === void 0 && (l = 0), s === void 0 && (s = 1), r > s ? s : r < l ? l : r),
  N = (r) => 'touches' in r,
  ...
  Oe = (r, l) => r.toLowerCase() === l.toLowerCase() || ne(K(r), K(l));
function le(r, l, s) {
  var h = L(s),
...
var $e = typeof window < 'u' ? p.useLayoutEffect : p.useEffect,
  Ne = () => (typeof __webpack_nonce__ < 'u' ? __webpack_nonce__ : void 0),
  A = new Map(),
  oe = (r) => {
    $e(() => {
  ...
  Re = (r) => v.createElement(Se, C({}, r, { colorModel: je })),
  ze = (r) => {
    var l = r.className,
      s = r.hsva,
      h = r.onChange,
