import { M as a } from './blocks-CZp0A3dp.js';
import { useMDXComponents as r } from './index-BNJdjGkk.js';
      ...
      e.jsxs('div', {
        ...
        children: [
          e.jsxs('div', {
            ...
            children: [
              e.jsx(i.h1, { id: 'configure-your-project', children: 'Configure your project' }),
              e.jsx(i.p, {
                children:
          ...
          e.jsxs('div', {
            ...
            children: [
              ...
              e.jsxs('div', {
                className: 'sb-section-item',
                children: [
                  e.jsx('img', { src: m, alt: 'A representation of typography and image assets' }),
                  e.jsxs('div', {
                    children: [
                      e.jsx('h4', {
                        className: 'sb-section-item-heading',
      ...
      e.jsxs('div', {
        ...
        children: [
          e.jsxs('div', {
            className: 'sb-section-title',
            children: [
              e.jsx(i.h1, { id: 'do-more-with-storybook', children: 'Do more with Storybook' }),
              e.jsx(i.p, {
                children:
              ...
              children: [
                e.jsxs('div', {
                  ...
                  children: [
                    ...
                    e.jsx('h4', { className: 'sb-section-item-heading', children: 'Autodocs' }),
                    e.jsx('p', {
                      className: 'sb-section-item-paragraph',
...
interactive reference documentation from your components and stories.`,
                ...
                e.jsxs('div', {
                  className: 'sb-grid-item',
                  children: [
                    e.jsx('img', { src: b, alt: 'Windows showing the Storybook plugin in Figma' }),
                    e.jsx('h4', { className: 'sb-section-item-heading', children: 'Figma Plugin' }),
                    e.jsx('p', {
                      className: 'sb-section-item-paragraph',
...
implementation in one place.`,
                ...
                e.jsxs('div', {
                  className: 'sb-grid-item',
                  children: [
                    e.jsx('img', { src: C, alt: 'Screenshot of tests passing and failing' }),
                    e.jsx('h4', { className: 'sb-section-item-heading', children: 'Testing' }),
                    e.jsx('p', {
                      className: 'sb-section-item-paragraph',
...
complex.`,
                ...
                e.jsxs('div', {
                  className: 'sb-grid-item',
                  children: [
                    e.jsx('img', { src: u, alt: 'Screenshot of Storybook in light and dark mode' }),
                    e.jsx('h4', { className: 'sb-section-item-heading', children: 'Theming' }),
                    e.jsx('p', {
                      className: 'sb-section-item-paragraph',
      ...
      e.jsxs('div', {
        ...
        children: [
          e.jsxs('div', {
            className: 'sb-section-item',
            children: [
              e.jsx('img', { src: n, alt: 'Github logo', className: 'sb-explore-image' }),
              e.jsx(i.p, {
          ...
          e.jsxs('div', {
            className: 'sb-section-item',
            children: [
              e.jsx('img', { src: c, alt: 'Discord logo', className: 'sb-explore-image' }),
              e.jsxs('div', {
                children: [
                  e.jsx(i.p, { children: 'Get support and chat with frontend developers.' }),
                  e.jsxs('a', {
          ...
          e.jsxs('div', {
            className: 'sb-section-item',
            children: [
              e.jsx('img', { src: l, alt: 'Youtube logo', className: 'sb-explore-image' }),
              e.jsxs('div', {
                children: [
                  e.jsx(i.p, { children: 'Watch tutorials, feature previews and interviews.' }),
                  e.jsxs('a', {
          ...
          e.jsxs('div', {
            className: 'sb-section-item',
            children: [
              e.jsx('img', { src: d, alt: 'A book', className: 'sb-explore-image' }),
              e.jsx('p', { children: 'Follow guided walkthroughs on for key workflows.' }),
              e.jsxs('a', {
