...
var Ie = Object.keys(P.color),
  we = Object.keys(P.bgColor);
[...Ie, ...we];
function je() {
  const e = new Map();
...
var W = qe,
  ...
  F = (e, r) => () => (r || (0, e[Re(e)[0]])((r = { exports: {} }).exports, r), r.exports),
  Je = (e, r, n, i) => {
  ...
  tt = F({
    'node_modules/pretty-format/build/plugins/DOMCollection.js'(e) {
      ...
      var r = ue(),
        ...
        p = (s) => s && s.constructor && !!s.constructor.name && _(s.constructor.name);
      e.test = p;
      ...
      var r = ge(),
        ...
        y = (E) => {
          const O = E.constructor.name,
            { nodeType: A, tagName: I } = E,
            j = (typeof I == 'string' && I.includes('-')) || o(E);
          return (
            (A === n && (p.test(O) || j)) ||
            (A === i && O === 'Text') ||
            (A === c && O === 'Comment') ||
        ...
        u = (E) => {
          var O;
          return (
            (E == null || (O = E.constructor) === null || O === void 0 ? void 0 : O.name) && y(E)
          );
        };
      e.test = u;
      function m(E) {
        ...
        return ++I > O.maxDepth
          ...
          : (0, r.printElement)(
              ...
              (0, r.printProps)(
                ...
                l(E)
                  ? {}
                  : Array.from(E.attributes).reduce((Y, h) => ((Y[h.name] = h.value), Y), {}),
                O,
                A + O.indent,
                I,
                j,
...
${U}`
      ...
      var ee = (t) =>
        ...
        oe = () => Z.reduce((t, b) => ((t[b] = { close: '', open: '' }), t), Object.create(null)),
        te = (t) => {
          var b;
        ...
        re = (t) => {
          var b;
          return (b = t == null ? void 0 : t.escapeRegex) !== null && b !== void 0
            ? b
            : k.escapeRegex;
        },
        ne = (t) => {
        ...
        le = (t) => {
          ...
          return {
            ...
            maxDepth:
              (M = t == null ? void 0 : t.maxDepth) !== null && M !== void 0 ? M : k.maxDepth,
            maxWidth:
              (S = t == null ? void 0 : t.maxWidth) !== null && S !== void 0 ? S : k.maxWidth,
