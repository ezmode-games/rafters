        ...
        <div className="prose prose-xl max-w-none">
          <div className="mb-32">
            ...
            <p className="text-body-large text-muted-foreground max-w-4xl">
              Design tokens are the foundational elements of our design system. They store
              visual design attributes as data, enabling consistent and scalable implementation
            ...
            <div className="space-y-12">
              ...
              <div className="space-y-12">
                <div>
                  ...
                  <p className="text-body text-muted-foreground">One place to define and maintain design decisions across all platforms and implementations</p>
                </div>
                <div>
                  <h4 className="heading-component mb-6">Scalable Consistency</h4>
                  <p className="text-body text-muted-foreground">Systematic approach to maintaining visual coherence as products grow</p>
                </div>
                <div>
                  <h4 className="heading-component mb-6">Theme Flexibility</h4>
                  <p className="text-body text-muted-foreground">Seamless switching between light, dark, and custom brand themes</p>
                </div>
                <div>
                  <h4 className="heading-component mb-6">Developer Efficiency</h4>
                  <p className="text-body text-muted-foreground">Semantic naming that makes design intent clear in code implementation</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-12">
              ...
              <div className="space-y-12">
                <div>
                  ...
                  <p className="text-body text-muted-foreground">Foundational values using OKLCH color space for precision</p>
                </div>
                <div>
                  <h4 className="heading-component mb-6">Semantic Tokens</h4>
                  <p className="text-body text-muted-foreground">Context-aware tokens that convey meaning and purpose</p>
                </div>
                <div>
                  <h4 className="heading-component mb-6">Component Tokens</h4>
                  <p className="text-body text-muted-foreground">Specialized tokens for specific interface components</p>
                </div>
                <div>
                  <h4 className="heading-component mb-6">State Modifiers</h4>
                  <p className="text-body text-muted-foreground">Interactive state values for hover, focus, and active states</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="my-40">
            ...
            <p className="text-body-large text-muted-foreground max-w-4xl mb-20">
              Our token system follows semantic naming conventions that describe purpose rather 
              than appearance. This approach enables flexible theming while maintaining clear 
            ...
            <div className="bg-accent/30 p-16 rounded-lg border-l-4 border-primary">
              ...
              <p className="text-body-large text-muted-foreground">
                Our default token values begin with a sophisticated grayscale palette, providing 
                an elegant foundation that works beautifully on its own while serving as the 
                perfect canvas for your brand colors through the customization wizard.
              </p>
            </div>
          </div>
        </div>
  ...
  render: () => <div className="px-16 py-24 max-w-7xl mx-auto">
      <div className="mb-16">
        ...
        <p className="text-body-large text-muted-foreground max-w-3xl">
          Core tokens define fundamental color values using OKLCH color space for 
          perceptual uniformity and precision. These form the foundation of all 
          semantic and component-specific tokens.
        </p>
      </div>
          ...
          <div className="prose max-w-none">
            ...
            <div className="mt-6 p-4 bg-background rounded border-l-4 border-primary">
              ...
              <ul className="mt-2 text-sm text-muted-foreground">
                <li><strong>Lightness:</strong> Perceptual lightness (0-1)</li>
                <li><strong>Chroma:</strong> Color intensity (0+)</li>
                <li><strong>Hue:</strong> Color angle (0-360)</li>
              </ul>
            </div>
          </div>
        </section>
...
n.parameters = {
  ...
  render: () => <div className="px-16 py-24 max-w-7xl mx-auto">
      <div className="mb-16">
        ...
        <p className="text-body-large text-muted-foreground max-w-3xl">
          Semantic tokens communicate meaning and purpose rather than specific colors.
          They enable consistent messaging patterns while supporting flexible theming
      ...
      <div className="space-y-16">
        ...
        <section className="bg-accent/20 p-8 rounded-lg">
          ...
          <div className="space-y-4 text-muted-foreground">
            <p>• <strong>Consistent meaning:</strong> Each semantic token should convey the same meaning across all contexts</p>
            <p>• <strong>Accessible contrast:</strong> All semantic tokens meet WCAG AAA standards with their foreground pairs</p>
            <p>• <strong>Cultural sensitivity:</strong> Consider cultural color associations when customizing semantic values</p>
            <p>• <strong>State clarity:</strong> Use semantic tokens to reinforce interface state and user feedback</p>
          </div>
        </section>
      </div>
    </div>,
...
t.parameters = {
  ...
  render: () => <div className="px-16 py-24 max-w-7xl mx-auto">
      <div className="mb-16">
        ...
        <p className="text-body-large text-muted-foreground max-w-3xl">
          Component tokens provide specialized styling for specific interface elements.
          They maintain systematic relationships to core tokens while enabling 
          fine-tuned control over individual component appearance.
        </p>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              <div className="p-4 border rounded-lg">
                ...
                <div className="text-sm text-muted-foreground mb-1">Accessibility focus indicator</div>
              ...
              <div className="p-4 border rounded-lg">
                ...
                <div className="text-sm text-muted-foreground mb-1">Element boundaries and dividers</div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-6 p-6 bg-muted/30 rounded-lg">
              ...
              <div className="flex-1 space-y-2">
                ...
                <div className="text-sm text-muted-foreground">Navigation containers and side panels</div>
              </div>
            </div>

            {/* Table Example */}
            <div className="space-y-2">
              <div className="bg-table-header p-3 rounded-t border font-medium">
                Table Header
              </div>
              ...
              <div className="mt-2 text-sm text-muted-foreground">
                <div className="font-mono text-xs">--color-table-header, --color-table-row-even, --color-table-row-hover</div>
                Data table styling tokens
              </div>
            </div>
          </div>
...
i.parameters = {
  ...
  render: () => <div className="px-16 py-24 max-w-7xl mx-auto">
      <div className="mb-16">
        ...
        <p className="text-body-large text-muted-foreground max-w-3xl">
          Guidelines for implementing design tokens effectively in development workflows.
          Learn about naming conventions, theme management, and customization strategies.
        </p>
      </div>
      ...
      <div className="space-y-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="space-y-4">
              ...
              <div className="space-y-2 text-sm text-muted-foreground">
                <p>• <strong>Category:</strong> color, font, space, radius</p>
                <p>• <strong>Property:</strong> background, foreground, border</p>
                <p>• <strong>Modifier:</strong> hover, active, disabled</p>
              </div>
            </div>
        ...
        <section className="space-y-8">
          ...
          <div className="prose max-w-none">
            <p>
              Our token system supports automatic dark mode switching and custom theming
              through CSS custom properties. Themes are defined using the same token
              structure with different values for each mode.
            </p>
            ...
            <div className="bg-muted/50 p-6 rounded-lg not-prose">
              ...
              <div className="space-y-4 text-sm">
                <div>
                  ...
                  <div className="font-mono text-muted-foreground">{":root { --color-background: oklch(1 0 0); }"}</div>
                </div>
                <div>
                  <div className="font-mono mb-2">{"/* Dark theme */"}</div>
                  <div className="font-mono text-muted-foreground">{".dark { --color-background: oklch(0.145 0 0); }"}</div>
                </div>
                <div>
                  <div className="font-mono mb-2">{"/* Custom theme */"}</div>
                  <div className="font-mono text-muted-foreground">{".brand { --color-primary: oklch(0.5 0.15 240); }"}</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-6 bg-primary/5 border border-primary/20 rounded-lg">
              ...
              <p className="text-sm text-muted-foreground">
                Define your primary brand colors and identity elements through 
                the /manage customization interface.
              </p>
            </div>
            ...
            <div className="p-6 bg-primary/5 border border-primary/20 rounded-lg">
              ...
              <p className="text-sm text-muted-foreground">
                System automatically generates semantic and component tokens 
                based on your brand values and accessibility requirements.
              </p>
            </div>
            ...
            <div className="p-6 bg-primary/5 border border-primary/20 rounded-lg">
              ...
              <p className="text-sm text-muted-foreground">
                Export and integrate your custom token values across all 
                platforms and applications using standard CSS properties.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-accent/20 p-8 rounded-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-muted-foreground">
            <div className="space-y-3">
              <p>• <strong>Use semantic names:</strong> Choose tokens based on purpose, not appearance</p>
              <p>• <strong>Maintain consistency:</strong> Apply tokens systematically across all components</p>
              <p>• <strong>Test accessibility:</strong> Verify contrast ratios with custom token values</p>
            </div>
            <div className="space-y-3">
              <p>• <strong>Document changes:</strong> Keep track of customizations and their reasoning</p>
              <p>• <strong>Version control:</strong> Manage token changes through proper versioning</p>
              <p>• <strong>Cross-platform sync:</strong> Ensure consistency across all implementation platforms</p>
            </div>
          </div>
        </section>
      </div>
