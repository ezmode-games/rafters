import {
  ...
  g as he,
  e as q,
} from './blocks-CZp0A3dp.js';
import { r as p, e as v } from './iframe-Bh_nZMRn.js';
    ...
    '../../node_modules/color-convert/route.js'(r, l) {
      ...
      function e(n, t) {
        let a = [t[n].parent, n],
          ...
          i = t[n].parent;
        while (t[i].parent)
          a.unshift(t[i].parent), (o = d(s[t[i].parent][i], o)), (i = t[i].parent);
...
var O = (r, l, s) => (l === void 0 && (l = 0), s === void 0 && (s = 1), r > s ? s : r < l ? l : r),
  S = (r) => 'touches' in r,
  B = (r) => (r && r.ownerDocument.defaultView) || self,
  T = (r, l, s) => {
    var h = r.getBoundingClientRect(),
      u = S(l)
        ? ((d, e) => {
            for (var n = 0; n < d.length; n++) if (d[n].identifier === e) return d[n];
            return d[0];
          })(l.touches, s)
        : l;
    return {
      left: O((u.pageX - (h.left + B(r).pageXOffset)) / h.width),
      top: O((u.pageY - (h.top + B(r).pageYOffset)) / h.height),
    };
  },
  W = (r) => {
  ...
  G = v.memo((r) => {
    var l = r.onMove,
      ...
      a = p.useMemo(() => {
        var f = (y) => {
            W(y),
              (S(y) ? y.touches.length > 0 : y.buttons > 0) && u.current
        ...
        return [
          (y) => {
            var m = y.nativeEvent,
              k = u.current;
            if (k && (W(m), !((x, j) => j && !S(x))(m, t.current) && k)) {
              if (S(m)) {
                t.current = !0;
  ...
  N = (r) => r.filter(Boolean).join(' '),
  F = (r) => {
    var l = r.color,
      s = r.left,
      h = r.top,
      u = h === void 0 ? 0.5 : h,
      d = N(['react-colorful__pointer', r.className]);
  ...
  w = (r, l, s) => (
    l === void 0 && (l = 0), s === void 0 && (s = Math.pow(10, l)), Math.round(s * r) / s
  ),
  ...
  we = (r, l) => (l === void 0 && (l = 'deg'), Number(r) * (ye[l] || 1)),
  ke = (r) => {
    var l =
  ...
  ee = (r) => {
    var l = r.r,
      ...
      d = Math.max(l, s, h),
      e = d - Math.min(l, s, h),
      n = e ? (d === l ? (s - h) / e : d === s ? 2 + (h - l) / e : 4 + (l - s) / e) : 0;
    return {
      h: w(60 * (n < 0 ? n + 6 : n)),
      s: w(d ? (e / d) * 100 : 0),
      v: w((d / 255) * 100),
    ...
    return v.createElement(
      ...
      v.createElement(
        G,
        {
          ...
          onKey: (u) => {
            s({ s: O(l.s + 100 * u.left, 0, 100), v: O(l.v - 100 * u.top, 0, 100) });
          },
          'aria-label': 'Color',
  ...
  ae = (r, l) => r.replace(/\s/g, '') === l.replace(/\s/g, ''),
  $e = (r, l) => r.toLowerCase() === l.toLowerCase() || ne(X(r), X(l));
function le(r, l, s) {
  var h = L(s),
    u = p.useState(() => r.toHsva(l)),
    d = u[0],
    e = u[1],
...
var Oe = typeof window < 'u' ? p.useLayoutEffect : p.useEffect,
  ...
  Re = (r) => v.createElement(Ne, C({}, r, { colorModel: je })),
  ze = (r) => {
    var l = r.className,
      s = r.hsva,
      h = r.onChange,
  ...
  He = { defaultColor: 'hsla(0, 0%, 0%, 1)', toHsva: ke, fromHsva: H, equal: ae },
  Ie = (r) => v.createElement(ue, C({}, r, { colorModel: He })),
  qe = {
  ...
  Pe = (r) => v.createElement(ue, C({}, r, { colorModel: qe })),
  ...
  Ke = M(fe)(({ theme: r }) => ({ fontFamily: r.typography.fonts.base })),
  De = M.div({
    display: 'grid',
  ...
  U = ({ value: r, style: l, ...s }) => {
    const h = `linear-gradient(${r}, ${r}), ${Ge}, linear-gradient(#fff, #fff)`;
  ...
  ie = ((r) => ((r.RGB = 'rgb'), (r.HSL = 'hsl'), (r.HEX = 'hex'), r))(ie || {}),
  P = Object.values(ie),
  ...
  er = (r) => {
    let l = r.replace('#', ''),
      ...
      u = r;
    /[^#a-f0-9]/i.test(r) ? (u = l) : D.test(r) && (u = `#${l}`);
    let d = !0;
    if (u.startsWith('#')) d = D.test(u);
    else
      try {
  ...
  nr = (r, l, s) => {
    const [h, u] = p.useState(l != null && l.valid ? [l] : []);
    p.useEffect(() => {
      l === void 0 && u([]);
    }, [l]);
    const d = p.useMemo(
      ...
      e = p.useCallback(
        (n) => {
          n != null &&
            n.valid &&
            (d.some((t) => t && t[s] && I(t[s] || '') === I(n[s] || '')) || u((t) => t.concat(n)));
        },
        [s, d]
      );
