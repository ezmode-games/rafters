import { B as s } from './Button-DdyNQfwD.js';
            ...
            <div className="space-y-3">
              <div className="space-y-2">
                ...
                <ul className="space-y-2 text-sm text-muted-foreground ml-4">
                  ...
                  <li>• Always include a noun if there is any room for interpretation about what the verb operates on</li>
                </ul>
              </div>
              <div className="space-y-2">
                <h4 className="text-base font-medium">Placement and hierarchy</h4>
                <ul className="space-y-2 text-sm text-muted-foreground ml-4">
                  <li>• Place buttons in consistent locations in the user interface for best user experience</li>
                  <li>• Use the button group component when there is a need to combine or lay out multiple buttons</li>
                  <li>• Express different emphasis levels (e.g. one primary button and one secondary button)</li>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="space-y-2">
                <h4 className="text-base font-medium">Button labels</h4>
                <ul className="space-y-2 text-sm text-muted-foreground ml-4">
                  <li>• No use of generic labels like "Ok" especially in the case of an error; errors are never "Ok"</li>
                </ul>
              </div>
              <div className="space-y-2">
...
const m = ['UsageGuidelines'];
export { t as UsageGuidelines, m as __namedExportsOrder, d as default };
