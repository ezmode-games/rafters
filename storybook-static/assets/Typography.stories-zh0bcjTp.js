        ...
        children: e.jsxs('div', {
          ...
          children: [
            e.jsxs('div', {
              className: 'mb-32',
              children: [
                e.jsx('h1', { className: 'heading-display mb-16', children: 'Typography' }),
                e.jsx('p', {
                  ...
                  children: [
                    e.jsxs('div', {
                      ...
                      children: [
                        ...
                        e.jsx('div', {
                          ...
                          children: 'φ⁴ × base-size (4.236rem) • font-display • responsive scaling',
                        }),
                        e.jsxs('div', {
                    ...
                    e.jsxs('div', {
                      ...
                      children: [
                        ...
                        e.jsx('div', {
                          className: 'text-sm text-muted-foreground',
                          children: 'φ³ × base-size (2.618rem) • font-display • responsive scaling',
                        }),
                        e.jsxs('div', {
                          className: 'text-sm text-muted-foreground mt-1',
                          children: [
                    ...
                    e.jsxs('div', {
                      ...
                      children: [
                        ...
                        e.jsx('div', {
                          className: 'text-sm text-muted-foreground',
                          children: 'φ² × base-size (1.618rem) • font-display • responsive scaling',
                        }),
                        e.jsxs('div', {
                          className: 'text-sm text-muted-foreground mt-1',
                        ...
                        e.jsxs('div', {
                          children: [
                            e.jsx('div', {
                              ...
                              children: 'DO use semantic classes:',
                            }),
                            e.jsx('code', {
                    ...
                    e.jsxs('div', {
                      ...
                      children: [
                        e.jsx('h4', {
                          ...
                          children: "DON'T: Verbose Utilities",
                        }),
                        e.jsxs('div', {
