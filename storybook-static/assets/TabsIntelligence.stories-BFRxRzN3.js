import { d as B, b as a, a as n, c as s, T as t } from './Tabs-Bcyagkfc.js';
import { r as u } from './iframe-Cy2I62ob.js';
...
r.parameters = {
  ...
  render: () => {
    ...
    description: {
      story: `Cognitive Load Optimization
...
Miller's 7±2 rule applied with visual hierarchy for scanning.`,
      ...((h = (v = r.parameters) == null ? void 0 : v.docs) == null ? void 0 : h.description),
    },
  },
};
let T;
...
Breadcrumb patterns show location within complex tab structures.`,
      ...((y = (f = o.parameters) == null ? void 0 : f.docs) == null ? void 0 : y.description),
    },
  },
};
let N;
...
l.parameters = {
  ...
  render: () => {
    ...
    return <>
      ...
      ...((w = (C = l.parameters) == null ? void 0 : C.docs) == null ? void 0 : w.source),
    },
    description: {
      story: `Mental Model Building
...
Progressive disclosure manages complexity without hiding functionality.`,
      ...((A = (S = l.parameters) == null ? void 0 : S.docs) == null ? void 0 : A.description),
    },
  },
};
let P;
...
c.parameters = {
  ...
  render: () => <>
      ...
      ...((k = (L = c.parameters) == null ? void 0 : L.docs) == null ? void 0 : k.source),
    },
    description: {
      story: `Motor Accessibility Focus
...
Clear focus states and proper ARIA attributes support all interaction methods.`,
      ...((M = (I = c.parameters) == null ? void 0 : I.docs) == null ? void 0 : M.description),
    },
  },
};
const q = [
  'CognitiveLoadOptimization',
  'WayfindingIntelligence',
  'MentalModelBuilding',
  'MotorAccessibilityFocus',
];
export {
  r as CognitiveLoadOptimization,
  l as MentalModelBuilding,
  c as MotorAccessibilityFocus,
  o as WayfindingIntelligence,
