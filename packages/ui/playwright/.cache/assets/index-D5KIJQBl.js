...
const _home_sean_projects_real_handy_rafters_packages_ui_examples_react_dialog_BasicDialogExample = () => __vitePreload(() => import('./react-dialog-BwQhSUIT.js'),true              ?[]:void 0).then((mod) => mod.BasicDialogExample);
const _home_sean_projects_real_handy_rafters_packages_ui_examples_react_dialog_ControlledDialogExample = () => __vitePreload(() => import('./react-dialog-BwQhSUIT.js'),true              ?[]:void 0).then((mod) => mod.ControlledDialogExample);
const _home_sean_projects_real_handy_rafters_packages_ui_examples_react_dialog_DialogWithReactHookForm = () => __vitePreload(() => import('./react-dialog-BwQhSUIT.js'),true              ?[]:void 0).then((mod) => mod.DialogWithReactHookForm);
const _home_sean_projects_real_handy_rafters_packages_ui_examples_react_dialog_NonModalDialogExample = () => __vitePreload(() => import('./react-dialog-BwQhSUIT.js'),true              ?[]:void 0).then((mod) => mod.NonModalDialogExample);
__pwRegistry.initialize({ _home_sean_projects_real_handy_rafters_packages_ui_examples_react_dialog_BasicDialogExample,
  _home_sean_projects_real_handy_rafters_packages_ui_examples_react_dialog_ControlledDialogExample,
  _home_sean_projects_real_handy_rafters_packages_ui_examples_react_dialog_DialogWithReactHookForm,
  _home_sean_projects_real_handy_rafters_packages_ui_examples_react_dialog_NonModalDialogExample });

export { React as R, reactExports as a, getDefaultExportFromCjs as g, requireReactDom as r };
//# sourceMappingURL=index-D5KIJQBl.js.map
