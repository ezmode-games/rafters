...
import { MenuCoordinationSystem, useAnnouncements, useFocusManager, useKeyboardNavigation, useMenu, useMotionCoordinator, } from '../MenuCoordinationSystem';
// Mock components for testing
const TestMenuComponent = ({ menuId, menuType, triggerFocus = false, triggerKeyboard = false, triggerAnnouncement = false, triggerMotion = false, }) => {
    ...
    return (_jsxs("div", { "data-testid": `menu-${menuId}`, children: [_jsx("button", { type: "button", onClick: handleTestAction, "data-testid": `trigger-${menuId}`, children: "Trigger Actions" }), _jsxs("div", { "data-testid": `status-${menuId}`, children: ["Active: ", menu.isActive ? 'true' : 'false', "Has Attention: ", menu.hasAttention ? 'true' : 'false'] })] }));
};
// Helper to render with coordination system
const renderWithCoordination = (children, props = {}) => {
    return render(_jsx(MenuCoordinationSystem, { ...props, children: children }));
};
describe('MenuCoordinationSystem', () => {
    ...
    describe('Core Menu Coordination', () => {
        it('should register and track multiple menus', async () => {
            renderWithCoordination(_jsxs(_Fragment, { children: [_jsx(TestMenuComponent, { menuId: "menu1", menuType: "dropdown" }), _jsx(TestMenuComponent, { menuId: "menu2", menuType: "navigation" }), _jsx(TestMenuComponent, { menuId: "menu3", menuType: "context" })] }));
        ...
        it('should enforce cognitive load budget', async () => {
            ...
            renderWithCoordination(_jsxs(_Fragment, { children: [_jsx(TestMenuComponent, { menuId: "heavy1", menuType: "navigation" }), _jsx(TestMenuComponent, { menuId: "heavy2", menuType: "navigation" }), _jsx(TestMenuComponent, { menuId: "heavy3", menuType: "navigation" }), _jsx(TestMenuComponent, { menuId: "heavy4", menuType: "navigation" })] }), {
        ...
        it('should manage attention hierarchy correctly', async () => {
            renderWithCoordination(_jsxs(_Fragment, { children: [_jsx(TestMenuComponent, { menuId: "dropdown", menuType: "dropdown" }), _jsx(TestMenuComponent, { menuId: "context", menuType: "context" }), _jsx(TestMenuComponent, { menuId: "navigation", menuType: "navigation" })] }));
    ...
    describe('Focus Management', () => {
        it('should create and manage focus traps', async () => {
            ...
            renderWithCoordination(_jsx(TestMenuComponent, { menuId: "focus-test", menuType: "dropdown", triggerFocus: true }), {
        ...
        it('should handle focus restoration', async () => {
            ...
            const { rerender } = renderWithCoordination(_jsx(TestMenuComponent, { menuId: "modal-test", menuType: "context", triggerFocus: true }));
            // Simulate menu closing (unmounting)
            rerender(_jsx(MenuCoordinationSystem, { children: _jsx("div", { children: "Menu closed" }) }));
        ...
        it('should handle keyboard navigation in focus traps', async () => {
            renderWithCoordination(_jsxs("div", { "data-testid": "trap-container", children: [_jsx(TestMenuComponent, { menuId: "keyboard-test", menuType: "dropdown", triggerFocus: true }), _jsx("button", { type: "button", "data-testid": "button1", children: "Button 1" }), _jsx("button", { type: "button", "data-testid": "button2", children: "Button 2" }), _jsx("button", { type: "button", "data-testid": "button3", children: "Button 3" })] }));
    ...
    describe('Keyboard Navigation', () => {
        it('should register and handle keyboard shortcuts', async () => {
            ...
            renderWithCoordination(_jsx(TestMenuComponent, { menuId: "kbd-test", menuType: "dropdown", triggerKeyboard: true }), {
        ...
        it('should handle type-ahead search', async () => {
            renderWithCoordination(_jsxs("div", { children: [_jsx(TestMenuComponent, { menuId: "search-test", menuType: "dropdown", triggerFocus: true }), _jsxs("div", { role: "menu", children: [_jsx("div", { role: "menuitem", tabIndex: 0, onKeyDown: (e) => e.key === 'Enter' && e.currentTarget.click(), children: "Apple" }), _jsx("div", { role: "menuitem", tabIndex: 0, onKeyDown: (e) => e.key === 'Enter' && e.currentTarget.click(), children: "Banana" }), _jsx("div", { role: "menuitem", tabIndex: 0, onKeyDown: (e) => e.key === 'Enter' && e.currentTarget.click(), children: "Cherry" })] })] }), {
        ...
        it('should handle menu-specific keyboard patterns', async () => {
            renderWithCoordination(_jsxs(_Fragment, { children: [_jsx(TestMenuComponent, { menuId: "nav-test", menuType: "navigation", triggerFocus: true }), _jsx(TestMenuComponent, { menuId: "tree-test", menuType: "tree", triggerFocus: true })] }));
    ...
    describe('Announcement Coordination', () => {
        it('should create ARIA live regions', async () => {
            renderWithCoordination(_jsx(TestMenuComponent, { menuId: "announce-test", menuType: "dropdown" }));
        ...
        it('should coordinate announcements without conflicts', async () => {
            ...
            renderWithCoordination(_jsxs(_Fragment, { children: [_jsx(TestMenuComponent, { menuId: "ann1", menuType: "dropdown", triggerAnnouncement: true }), _jsx(TestMenuComponent, { menuId: "ann2", menuType: "context", triggerAnnouncement: true })] }), {
        ...
        it('should handle announcement priorities correctly', async () => {
            renderWithCoordination(_jsx(TestMenuComponent, { menuId: "priority-test", menuType: "context", triggerAnnouncement: true }));
        ...
        it('should debounce identical announcements', async () => {
            const onAnnouncement = vi.fn();
            renderWithCoordination(_jsx(TestMenuComponent, { menuId: "debounce-test", menuType: "dropdown", triggerAnnouncement: true }), {
                announcements: { onAnnouncement },
            });
    ...
    describe('Motion Coordination', () => {
        it('should coordinate animations with priority system', async () => {
            ...
            renderWithCoordination(_jsxs(_Fragment, { children: [_jsx(TestMenuComponent, { menuId: "motion1", menuType: "dropdown", triggerMotion: true }), _jsx(TestMenuComponent, { menuId: "motion2", menuType: "context", triggerMotion: true })] }), {
        ...
        it('should enforce performance budgets', async () => {
            ...
            renderWithCoordination(_jsxs(_Fragment, { children: [_jsx(TestMenuComponent, { menuId: "perf1", menuType: "navigation", triggerMotion: true }), _jsx(TestMenuComponent, { menuId: "perf2", menuType: "navigation", triggerMotion: true }), _jsx(TestMenuComponent, { menuId: "perf3", menuType: "navigation", triggerMotion: true }), _jsx(TestMenuComponent, { menuId: "perf4", menuType: "navigation", triggerMotion: true })] }), {
                motionCoordinator: {
        ...
        it('should respect reduced motion preferences', async () => {
            ...
            renderWithCoordination(_jsx(TestMenuComponent, { menuId: "reduced-motion", menuType: "dropdown", triggerMotion: true }));
    ...
    describe('System Integration', () => {
        it('should handle complex multi-menu scenarios', async () => {
            ...
            renderWithCoordination(_jsxs(_Fragment, { children: [_jsx(TestMenuComponent, { menuId: "complex1", menuType: "navigation", triggerFocus: true, triggerKeyboard: true, triggerAnnouncement: true, triggerMotion: true }), _jsx(TestMenuComponent, { menuId: "complex2", menuType: "dropdown", triggerFocus: true, triggerKeyboard: true, triggerAnnouncement: true, triggerMotion: true })] }), {
        ...
        it('should properly clean up when menus unmount', async () => {
            const { rerender } = renderWithCoordination(_jsx(TestMenuComponent, { menuId: "cleanup-test", menuType: "dropdown", triggerFocus: true }));
            // Menu should be active
            expect(screen.getByTestId('status-cleanup-test')).toHaveTextContent('Active: true');
            // Unmount the menu
            rerender(_jsx(MenuCoordinationSystem, { children: _jsx("div", { children: "Menu removed" }) }));
        ...
        it('should handle error conditions gracefully', async () => {
            ...
            renderWithCoordination(_jsx(TestMenuComponent, { menuId: "error-test", menuType: "dropdown" }));
    ...
    describe('Performance', () => {
        it('should not cause unnecessary re-renders', async () => {
            ...
            const TestComponent = () => {
                renderSpy();
                return _jsx(TestMenuComponent, { menuId: "perf-test", menuType: "dropdown" });
            };
            const { rerender } = renderWithCoordination(_jsx(TestComponent, {}));
            const initialRenderCount = renderSpy.mock.calls.length;
            // Trigger various actions that shouldn't cause re-renders
            rerender(_jsx(MenuCoordinationSystem, { children: _jsx(TestComponent, {}) }));
            expect(renderSpy.mock.calls.length).toBe(initialRenderCount + 1); // Only one additional render
        });
        it('should handle high-frequency events efficiently', async () => {
            renderWithCoordination(_jsx(TestMenuComponent, { menuId: "freq-test", menuType: "dropdown", triggerFocus: true }));
...
describe('MenuCoordinationDebugger', () => {
    it('should provide debug information', async () => {
        ...
        render(_jsx(MenuCoordinationSystem, { enableDebugMode: true, children: _jsx(TestMenuComponent, { menuId: "debug-test", menuType: "dropdown", triggerAnnouncement: true }) }));
...
//# sourceMappingURL=MenuCoordinationSystem.test.js.map