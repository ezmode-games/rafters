 ...
 */
const meta = {
  title: '03 Components/Navigation/Sidebar/Properties',
  component: Sidebar,
  parameters: {
    layout: 'fullscreen',
    docs: {
          ...
          <div className="max-w-2xl space-y-6">
            ...
            <div className="grid gap-4">
              ...
              <div className="p-4 bg-background border rounded-lg">
                ...
                <p className="text-sm text-muted-foreground">
                  Visual indentation creates clear parent-child relationships in complex navigation
                  structures.
                </p>
              </div>
            </div>
          ...
          <div className="max-w-2xl space-y-6">
            ...
            <div className="grid gap-4">
              ...
              <div className="p-4 bg-background border rounded-lg">
                ...
                <p className="text-sm text-muted-foreground">
                  User preference for collapsed/expanded state is remembered across sessions through
              ...
              <div className="p-4 bg-background border rounded-lg">
                ...
                <p className="text-sm text-muted-foreground">
                  Hover tooltips in collapsed mode provide full context without requiring expansion
                  for quick navigation reference.
                </p>
              </div>
