 ...
 */
const meta = {
  title: 'Components/Sidebar/Semantic',
  component: Sidebar,
  parameters: {
    layout: 'fullscreen',
    docs: {
            ...
            <div className="max-w-2xl space-y-6">
              ...
              <div className="grid gap-4">
                <div className="p-4 bg-background border rounded-lg">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Publishing section follows content creation flow from drafts through scheduling
                    to publication.
                  </p>
                </div>
                ...
                <div className="p-4 bg-background border rounded-lg">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Taxonomy tools (categories, tags) and author management support content
            ...
            <div className="max-w-2xl space-y-6">
              ...
              <div className="grid gap-4">
                ...
                <div className="p-4 bg-background border rounded-lg">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Critical system alerts are prominently displayed to ensure immediate visibility
            ...
            <div className="max-w-2xl space-y-6">
              ...
              <div className="grid gap-4">
                ...
                <div className="p-4 bg-background border rounded-lg">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Visual indentation shows content relationships and depth without overwhelming
