...
const SemanticDemo = ({
  ...
  purpose,
  description,
}: { element: string; purpose: string; description: string }) => (
  <div className="space-y-3">
    ...
    <div className="bg-muted/10 p-4 rounded border">
      <p className="text-body-small">
        Semantic HTML structure improves accessibility, SEO, and screen reader navigation while
        maintaining visual consistency through design system tokens.
      </p>
    </div>
  </div>
);
...
export const SemanticElements: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Demonstrates semantic HTML elements with Container component for proper document structure and accessibility. Each element serves specific purposes for screen readers and SEO.',
      },
    },
  },
};
...
export const DocumentStructure: Story = {
      ...
      <Container as="main" variant="wide" padding="phi-2">
        <div className="space-y-8">
          <Container
            ...
            variant="golden"
            padding="phi-1"
            className="text-center bg-primary/5 rounded-lg"
          >
            ...
            >
              <div className="space-y-4">
                ...
                <p className="text-body">
                  This article demonstrates how Container components maintain semantic meaning while
                  providing consistent layout intelligence through design system tokens.
                </p>
                <p className="text-body">
                  The reading variant ensures optimal line length for sustained reading, while
                  phi-based spacing creates natural visual rhythm.
                </p>
                ...
                <Container
                  ...
                  variant="reading"
                  padding="phi-1"
                  className="bg-accent/10 rounded"
                >
                  <h3 className="heading-subsection">Nested Sections</h3>
                  <p className="text-body-small">
                    Sections within articles create hierarchical content structure that assistive
                    technology can navigate efficiently.
                  </p>
                </Container>
              </div>
            </Container>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-success rounded-full mt-3" />
                    <div>
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Complete document structure example showing how semantic Container elements create proper HTML hierarchy for accessibility and SEO while maintaining design consistency.',
      },
    },
  },
};
...
export const LandmarkNavigation: Story = {
    ...
    <div className="min-h-screen bg-background">
      <div className="space-y-6 p-6">
        <div className="bg-info/10 border border-info rounded-lg p-4">
          ...
          <p className="text-body-small">
            Screen reader users can press landmark navigation keys to jump between semantic
            elements. Try using a screen reader to navigate this page structure.
          </p>
        </div>
        ...
        <Container as="main" variant="wide" padding="phi-1" className="bg-primary/5 rounded-lg">
          ...
          <p className="text-body mb-6">
            This main landmark contains the primary content of the page. Screen readers announce
            this as "main region" and allow quick navigation via the 'M' key.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              ...
              <p className="text-body-small">
                Sections create thematic groupings that screen readers can navigate using heading
                navigation or region commands.
              </p>
            </Container>
            ...
            >
              ...
              <p className="text-body-small">
                Each section maintains independent semantic meaning while sharing consistent visual
                treatment through design system tokens.
              </p>
            </Container>
          </div>
          ...
          <Container
            ...
            variant="golden"
            padding="phi-2"
            className="mt-8 bg-accent/10 rounded-lg"
          >
            <h2 className="heading-subsection mb-4">Featured Article</h2>
            <p className="text-body mb-4">
              Articles represent standalone content that could be syndicated or distributed
              independently. Screen readers announce article boundaries clearly for better content
              comprehension.
            </p>
            <p className="text-body-small text-muted-foreground">
              This semantic structure combined with design system tokens creates both accessible and
              visually consistent user experiences.
            </p>
          </Container>
        </Container>
      </div>
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Landmark navigation demonstration showing how semantic Container elements create navigable page structure for assistive technology users.',
      },
    },
  },
};
