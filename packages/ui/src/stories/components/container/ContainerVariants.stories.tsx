  ...
  <div className="space-y-4">
    ...
    <div className="bg-muted/10 p-4 rounded border border-muted">
      <p className="text-body-small">
        Content adapted to this container variant using design system tokens for consistent,
        predictable layout behavior across all applications.
      </p>
    </div>
  </div>
);
...
export const ContainerVariants: Story = {
      ...
      <div className="space-y-6">
        <div className="border border-muted rounded-lg p-6">
          <Container
            variant="reading"
            padding="phi-1"
            className="bg-accent/5 border border-accent rounded"
          >
            <VariantDemo
              variant="Reading"
  ...
  parameters: {
    docs: {
      description: {
        story:
          'All container variants using design system tokens. Each variant serves specific layout purposes with mathematical proportions for optimal user experience.',
      },
    },
  },
};
...
export const VariantComparison: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Visual comparison of container variants showing relative sizes and proportional relationships using design system tokens.',
      },
    },
  },
};
...
export const ResponsiveBehavior: Story = {
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Container
              variant="reading"
              padding="phi-1"
              className="bg-info/10 border border-info rounded"
            >
            ...
            <Container
              variant="golden"
              padding="phi-1"
              className="bg-warning/10 border border-warning rounded"
            >
            ...
            <Container
              variant="wide"
              padding="phi-1"
              className="bg-success/10 border border-success rounded"
            >
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Demonstrates how container variants respond to different screen sizes while maintaining optimal proportions and readability.',
      },
    },
  },
};
