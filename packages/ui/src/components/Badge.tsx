 ...
 * @registryPath components/ui/Badge.tsx
 * @registryType registry:component
 *
 * @cognitiveLoad 2/10 - Simple status indicators designed for peripheral scanning
 * @attentionEconomics Secondary element that supports primary content without competing for attention
 * @trustBuilding Clear status communication with consistent visual patterns
 * @accessibility WCAG AAA compliant with color, icon, and text for multi-sensory communication
 * @semanticMeaning Variants communicate specific states: success, warning, error, info, neutral
 *
 * @usagePatterns
 * DO: Use for status indicators and category labels
 * DO: Combine with icons for enhanced accessibility
 * DO: Interactive badges for removable tags
 * NEVER: Primary actions or critical alerts requiring immediate response
 *
 * @designGuides
 ...
 * <Badge variant="info" removable onRemove={() => {}}>Category</Badge>
 * ```
 */
