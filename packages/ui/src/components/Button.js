...
export function Button({ variant = 'primary', size = 'md', asChild = false, className, disabled, loading = false, destructiveConfirm = false, children, ref, ...props }) {
    ...
    return (_jsx(Comp, { ref: ref, className: cn(
        ...
        'inline-flex items-center justify-center rounded-md text-sm font-medium', 'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2', 'disabled:pointer-events-none disabled:opacity-disabled', 'transition-all motion-hover', 'hover:opacity-hover active:scale-active', 
        ...
        }, className), disabled: isInteractionDisabled, "aria-busy": loading, "aria-label": shouldShowConfirmation ? `Confirm to ${children}` : undefined, ...props, children: asChild ? (children) : (_jsxs(_Fragment, { children: [loading && (_jsxs("svg", { className: "animate-spin -ml-1 mr-2 h-4 w-4", fill: "none", viewBox: "0 0 24 24", "aria-hidden": "true", children: [_jsx("circle", { className: "opacity-25", cx: "12", cy: "12", r: "10", stroke: "currentColor", strokeWidth: "4" }), _jsx("path", { className: "opacity-75", fill: "currentColor", d: "M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" })] })), shouldShowConfirmation && !loading && (_jsx("span", { className: "mr-1 text-xs font-bold", "aria-hidden": "true", children: "!" })), children] })) }));
}
