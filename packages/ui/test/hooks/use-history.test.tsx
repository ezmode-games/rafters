...
describe('useHistory', () => {
  ...
  describe('batch', () => {
    it('groups multiple changes into single undo step', () => {
      const { result } = renderHook(() => useHistory({ initialState: [] as string[] }));
  ...
  describe('stable function references', () => {
    it('maintains stable references across renders', () => {
      const { result, rerender } = renderHook(() => useHistory({ initialState: 0 }));
  ...
  describe('generic types', () => {
    ...
    it('works with union types', () => {
      ...
      const { result } = renderHook(() => useHistory<Status>({ initialState: 'idle' }));
