...
@theme {
  /* Color Tokens */
  --color-primary: oklch(0.45 0.15 260);        /* Modified by Studio */
  --color-primary-foreground: oklch(0.98 0 0);
  --color-destructive: oklch(0.4 0.15 20);
  
  /* Spacing Tokens (mathematical) */
  --spacing-xs: 0.25rem;
  --spacing-sm: 0.5rem;
  --spacing-md: 1rem;
  --spacing-lg: 1.618rem;  /* Golden ratio */
...
### To Build
- **Export Functions**: `exportTokens()` implementation
- **CSS Generator**: Convert tokens to Tailwind v4 format
- **JSON Writer**: Save tokens to `.rafters/tokens/`
- **Studio Integration**: Read/write modified tokens
