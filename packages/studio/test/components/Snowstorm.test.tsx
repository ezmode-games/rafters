...
vi.mock('../../src/components/first-run/ColorPicker', () => ({
  ColorPicker: vi.fn(({ color, anchorPosition, onConfirm, onCancel }) => (
    <div data-testid="color-picker">
      ...
      <button onClick={() => onConfirm(color, 'test reason')}>Confirm</button>
...
describe('Snowstorm', () => {
  ...
  describe('color picking', () => {
    ...
    it('calculates color from position', () => {
      ...
      const colorData = screen.getByTestId('picker-color').textContent;
    ...
    it('passes click position to ColorPicker', () => {
      ...
      const positionData = screen.getByTestId('picker-position').textContent;
  ...
  describe('position to color mapping', () => {
    ...
    testCases.forEach(({ click, expected }) => {
