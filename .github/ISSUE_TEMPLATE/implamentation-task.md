...
- Must pass `pnpm typecheck:root` validation
...
- [ ] All functional tests pass with 80% coverage minimum
- [ ] TypeScript compiles without errors (no `any` types)
- [ ] `pnpm preflight` passes completely
- [ ] Performance requirements met
- [ ] Integration tests pass
- [ ] Biome linting passes without violations
