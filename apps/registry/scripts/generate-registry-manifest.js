...
const componentsDir = path.resolve(process.cwd(), '../../packages/ui/src/components');
const manifestPath = path.resolve(process.cwd(), 'registry-manifest.json');
