...
const manifestPath = path.resolve(__dirname, '../app/lib/registry/registryData.ts');
...
try {
  ...
  // Generate TypeScript file that exports the manifest
  const tsContent = `/**
 * Generated Registry Manifest
 * 
 * This file is auto-generated from component JSDoc comments.
 * Do not edit manually - changes will be overwritten.
 */

export const registryManifest = ${JSON.stringify(validatedManifest, null, 2)} as const;
