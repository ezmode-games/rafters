...
import { type ComponentManifest as RegistryComponent, fetchComponent } from '../utils/registry.js';
...
function createBasicStory(componentManifest: RegistryComponent): string {
